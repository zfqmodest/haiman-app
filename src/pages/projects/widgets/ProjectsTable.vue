...
const columns = computed(() =>
  defineVaDataTableColumns([
    { label: t('projects.table.projectName'), key: 'project_name', sortable: true },
    { label: t('projects.table.projectOwner'), key: 'project_owner', sortable: true },
    { label: t('projects.table.team'), key: 'team', sortable: true },
    { label: t('projects.table.status'), key: 'status', sortable: true },
    { label: t('projects.table.creationDate'), key: 'created_at', sortable: true },
    { label: t('projects.table.actions'), key: 'actions', sortable: false },
  ]),
)
...
<template>
  <div>
      ...
      <template #cell(actions)="{ rowData: project }">
        <div class="flex gap-3 justify-start items-center">
          <VaButton
            ...
            color="primary"
            icon="mso-edit"
            :aria-label="t('projects.table.editProject')"
          ...
          <VaButton
            ...
            icon="mso-delete"
            color="danger"
            :aria-label="t('projects.table.deleteProject')"
    ...
    <div class="flex flex-col-reverse md:flex-row gap-2 justify-between items-center py-2">
      <div>
        <b>{{ $props.pagination.total }} {{ t('projects.table.results') }}.</b>
        {{ t('projects.table.resultsPerPage') }}
      ...
      <div v-if="totalPages > 1" class="flex">
        <VaButton
          preset="secondary"
          icon="va-arrow-left"
          :aria-label="t('projects.table.previousPage')"
        ...
        <VaButton
          ...
          preset="secondary"
          icon="va-arrow-right"
          :aria-label="t('projects.table.nextPage')"
